...
namespace ASEParser
{
	...
	struct Vertex
	{
		...
		pair<int, float> m_bw1, m_bw2, m_bw3, m_bw4, m_bw5, m_bw6, m_bw7, m_bw8, m_bw9;
	...
	public:
		...
		MaterialMap* m_map_specular;	
		MaterialMap* m_map_shine;	
	...
	public:
		...
		/// *MESH_FACENORMAL
		/// *MESH_VERTEXNORMAL
		//vector<Face*> m_normalList;	// 여기에 노말 값을 저장해서 m_meshface의 데이터와 비교하자.
		vector<vector<pair<int , Vector3>>> m_normalList;
		// 여기에다가 2차원 배열 만들면 돼
		// int, vector3 사이즈는 몰르고?
		// 응 응 사이즈는 ase 파서 열어봐야 알듯 
