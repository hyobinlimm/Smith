...
namespace ASEParser
{
	Vertex::Vertex()
		...
		, m_bw1({ 0, 0.0f }), m_bw2({ 0, 0.0f }), m_bw3({ 0, 0.0f }), m_bw4({ 0, 0.0f }),
		m_bw5({ 0, 0.0f }), m_bw6({ 0, 0.0f }), m_bw7({ 0, 0.0f }), m_bw8({ 0, 0.0f }), m_bw9({ 0, 0.0f }),
		m_indices(0), m_weightIndices{0, }, m_indicesPointer(nullptr)
	{
